...
formDiv.addEventListener("submit", (e) => {
  ...
  let savedData = localStorage.setItem("user", JSON.stringify(studentData))
  
  // let dataget = localStorage.getItem("user")
  // let modify = JSON.parse(dataget)
  // userTag.innerHTML =  modify.username
  ...
  //   })
  //   .then((response) => {
  //     if(response) alert("your accound has been successfully created")
